...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CANSparkMax leftMotor1 = new CANSparkMax(3, MotorType.kBrushless);

    CANSparkMax rightMotor1 = new CANSparkMax(7, MotorType.kBrushless);

    SpeedController[] leftMotors = new SpeedController[1];
    leftMotors[0] = new CANSparkMax(2, MotorType.kBrushless);

    SpeedController[] rightMotors = new SpeedController[1];
    rightMotors[0] = new CANSparkMax(8, MotorType.kBrushless);
    ...
    leftEncoder.setPositionConversionFactor((1.0/12.0) * WHEEL_DIAMETER * Math.PI);
    leftEncoder.setVelocityConversionFactor((1.0/12.0) * WHEEL_DIAMETER * Math.PI);
    leftEncoderPosition = leftEncoder::getPosition;
    leftEncoderRate = leftEncoder::getVelocity;

    CANEncoder rightEncoder = rightMotor1.getEncoder();
    rightEncoder.setPositionConversionFactor((1.0/12.0) * WHEEL_DIAMETER * Math.PI);
    rightEncoder.setVelocityConversionFactor((1.0/12.0) * WHEEL_DIAMETER * Math.PI);
    //rightEncoder.setInverted(true);
    rightEncoderPosition = rightEncoder::getPosition;
    rightEncoderRate = rightEncoder::getVelocity;
