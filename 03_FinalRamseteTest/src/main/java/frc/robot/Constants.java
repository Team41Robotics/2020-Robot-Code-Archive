...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double ksVolts = .15; //.94 .15
    public static final double kvVoltSecondsPerMeter = .0386; //3.26 .0386
    public static final double kaVoltSecondsSquaredPerMeter = .0101; //.461 .0101

    // Example value only - as above, this must be tuned for your drive!
    public static final double kPDriveVel = .486; //talon: 0.00299 WPILIB: 15.4
  }
